...
def create(request):
    if request.method == 'POST':
        data = {
            ...
            'Pictures': [{'url': request.POST.get('url') or 'https://sl.d.umn.edu/och/PhotoGallery/no-image-available.jpg'}],
        ...
        #notify on create
             messages.success(request, 'New Movie Added: []'.format (respose['fields'].get('Name')))
